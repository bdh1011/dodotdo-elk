...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 *
	 * context: {"env":"production","sourceMaps":false,"kbnVersion":"4.2.1","buildNum":9019}
	 * includes code from:
	 *  - elasticsearch@1.0.0
	...
	__webpack_require__(989).bootstrap();
	/* xoxo */
...
/***/ function(module, exports, __webpack_require__) {
	...
	var notify = __webpack_require__(1039);

	__webpack_require__(1640);
	__webpack_require__(1646);

	__webpack_require__(989).setTabs([{
	  id: '',
	  title: 'Server Status',
	  activeIndicatorColor: '#EFF0F2'
	}]).setRootTemplate(__webpack_require__(1647)).setRootController('ui', function ($http, $scope) {
	  var ui = this;
	  ui.loading = false;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var numeral = __webpack_require__(872);
	__webpack_require__(979);

	var toTitleCase = __webpack_require__(1642);
	var formatNumber = __webpack_require__(1643);
	var readStatData = __webpack_require__(1644);
	...
	__webpack_require__(997).get('kibana', ['nvd3']).directive('statusPageMetric', function () {
	  return {
	    restrict: 'E',
